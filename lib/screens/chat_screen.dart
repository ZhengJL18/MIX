// 聊天主界面（从 main.dart 拆分，Step 3）。
// 自包含：依赖仅通过 Services.instance 与 import 库获取。
...
import 'package:mix/agent/workflow.dart';
...
import 'package:mix/refine/edit_journal.dart';
import 'package:mix/refine/prompt_notes_store.dart';
import 'package:mix/refine/refine_pipeline.dart';
import 'package:mix/refine/trajectory_store.dart';
import 'package:mix/screens/settings_screen.dart';
...
import 'package:mix/services/multi_agent.dart';
import 'package:mix/services/notes_sync.dart';
import 'package:mix/services/services.dart';
import 'package:mix/services/storage_permission.dart';
import 'package:mix/services/study_engine.dart';
import 'package:mix/services/study_question_service.dart';
import 'package:mix/services/update_service.dart';
import 'package:mix/theme/theme_ext.dart';
import 'package:mix/theme/theme_provider.dart';
import 'package:mix/tools/clarify_tool.dart';
import 'package:mix/tools/company_tool.dart';
import 'package:mix/tools/context_retriever.dart';
...
import 'package:mix/tools/git_tools.dart';
import 'package:mix/tools/goal_tool.dart';
import 'package:mix/tools/memory_manager.dart';
import 'package:mix/tools/memory_search_tool.dart';
import 'package:mix/tools/memory_tool.dart';
import 'package:mix/tools/memory_verify_tool.dart';
import 'package:mix/tools/moa_tool.dart';
import 'package:mix/tools/model_tools.dart';
import 'package:mix/tools/notes_tools.dart';
import 'package:mix/tools/convert_tools.dart';
import 'package:mix/tools/read_doc_tool.dart';
import 'package:mix/tools/session_search_tool.dart';
import 'package:mix/tools/skills_tool.dart';
import 'package:mix/tools/study_status_tool.dart';
import 'package:mix/tools/study_tools.dart';
import 'package:mix/tools/todo_tool.dart';
import 'package:mix/tools/vision_tool.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    Services.instance.resumeSessionHandler = _resumeSession;
    // 设置页「检查更新」→ 复用聊天页的检查逻辑。
    Services.instance.checkUpdateHandler = _checkForUpdateManually;
    // 加载持久化的聊天思考强度（默认中档）。
